...
<head>
  ...
  <style>
    ...
    *, *::before, *::after {{
    ...
    /* ==========================================================================
       INTERACTIVE CHARACTER CONSISTENCY NODE CANVAS (N8N / HIGGSFIELD / MAGNIFIC STYLE)
       ========================================================================== */
    .node-canvas-section {{
    ...
    .cable-path-pulse {{
      ...
      animation: cablePhoton 2.4s linear infinite;
    }}
    ...
    @media (max-width: 1080px) {{
      ...
      .canvas-svg-overlay {{ display: none; }}
    }}
    ...
    .n-port-r {{ right: -12px; top: 50%; transform: translateY(-50%); }}
    .n-port-l {{ left: -12px; top: 50%; transform: translateY(-50%); }}
    .n-port-purple {{
      border-color: #a855f7;
      color: #c084fc;
...
<body>
  ...
  <main id="mainContent">
    ...
    <!-- 2. INTERACTIVE CHARACTER CONSISTENCY NODE CANVAS -->
    <section class="node-canvas-section wrap" id="node-canvas">
      <div class="section-head">
        ...
        <p class="section-desc" data-i18n="canvas_desc">Từ một ảnh gốc, tự động truyền nhận dạng sang ChatGPT, Google Flow và Grok để sinh video 4K và bộ ảnh đồng nhất 100%.</p>
      </div>

      <div class="dot-grid-canvas" id="nodeCanvasContainer">
        <!-- Glowing Dynamic SVG Bézier Spline Overlay -->
        <svg class="canvas-svg-overlay" id="dynamicCanvasSvg"></svg>

        <div class="node-graph-grid">
          <!-- Col 1: Reference Node + Prompt ChatGPT -->
          <div style="display:flex;flex-direction:column;gap:24px;">
            <!-- Node 1: Reference Image -->
            <div class="n-node-card" id="node-ref">
              ...
              <div class="n-node-img-box" style="aspect-ratio: 3/4;">
                <img src="assets/workflow-ref-img.jpg" onerror="this.src='landing/assets/workflow-ref-img.jpg'" alt="Character Reference" loading="lazy" width="240" height="320" />
                <div class="n-node-zoom-btn">🔍</div>
              </div>
              <div class="n-node-footer">
                <span style="color:#a3e635;" class="node-status-dot">● Active Lock</span>
                <span>Entity #OID-Boy</span>
              </div>
            </div>

            <!-- Node 2: Prompt for ChatGPT -->
            <div class="n-node-card" id="node-p-chatgpt">
              <div class="n-node-port n-port-r" id="port-pchatgpt-out" style="top:50%;">T</div>
              <div class="n-node-head">
                <span>📝 Prompt (ChatGPT)</span>
                <span class="n-node-tag">571/40,000</span>
              </div>
              <div class="n-node-prompt-body">
                Use the uploaded reference image to preserve the subject's identity, outfit and proportions. Restyle it into a cinematic editorial portrait with 35mm film look.
              </div>
              <div class="n-node-footer">
          ...
          <!-- Col 2: Prompts & ChatGPT Node -->
          <div style="display:flex;flex-direction:column;gap:24px;">
            <!-- Node 3: Prompt Flow Video -->
            <div class="n-node-card" id="node-p-flow">
              ...
              <div class="n-node-prompt-body">
                Animate the reference character into an 8-second cinematic video. Slow dolly-in toward the subject with smooth gimbal motion. Hair and fabric react gently to a soft breeze.
              </div>
              <div class="n-node-footer">
                <span style="color:var(--cyan);">Plain</span>
            ...
            <!-- Node 4: ChatGPT Center -->
            <div class="n-node-card" id="node-chatgpt">
              ...
              <div class="n-node-img-box" style="aspect-ratio: 16/9;">
                <img src="assets/workflow-chatgpt-result.jpeg" onerror="this.src='landing/assets/workflow-chatgpt-result.jpeg'" alt="ChatGPT Scene" loading="lazy" width="300" height="170" />
                <div class="n-node-zoom-btn">🔍</div>
              </div>
              <div class="n-node-footer">
                <span style="color:#10a37f;">● Direct Identity Pass</span>
                <span>NYC Day Scene</span>
              </div>
            </div>

            <!-- Node 5: Prompt Grok Poster -->
            <div class="n-node-card" id="node-p-grok">
              ...
              <div class="n-node-prompt-body">
                Reimagine the reference subject as a bold poster shot. High-contrast studio lighting with dramatic shadows. Vibrant accent colors and crisp clean edges in Times Square.
              </div>
              <div class="n-node-footer">
          ...
          <!-- Col 3: Final Video & Poster Render -->
          <div style="display:flex;flex-direction:column;gap:24px;">
            <!-- Node 6: Flow Video (Real HTML5 MP4 Video Player) -->
            <div class="n-node-card" id="node-flow">
              ...
              <div class="n-node-img-box" style="aspect-ratio: 16/9;position:relative;">
                <video class="n-node-video" autoplay loop muted playsinline preload="auto" poster="assets/workflow-chatgpt-result.jpeg">
                  <source src="assets/workflow-flow-video-result.mp4" type="video/mp4">
                  <source src="landing/assets/workflow-flow-video-result.mp4" type="video/mp4">
                </video>
              </div>
              <div class="n-node-footer">
            ...
            <!-- Node 7: Grok Poster -->
            <div class="n-node-card" id="node-grok">
              ...
              <div class="n-node-img-box" style="aspect-ratio: 16/9;">
                <img src="assets/workflow-grok-result.jpeg" onerror="this.src='landing/assets/workflow-grok-result.jpeg'" alt="Grok Times Square Render" loading="lazy" width="560" height="315" />
                <div class="n-node-zoom-btn">🔍</div>
              </div>
              <div class="n-node-footer">
  ...
  <script>
    ...
    // 15. Dynamic SVG Cable Renderer & Workflow Simulation
    const CABLE_EDGES = [
      {{ from: 'port-ref-out', to: 'port-chatgpt-in-img', color: 'purple', class: 'cable-e1' }},
      {{ from: 'port-pchatgpt-out', to: 'port-chatgpt-in-txt', color: 'cyan', class: 'cable-e2' }},
      {{ from: 'port-chatgpt-out-flow', to: 'port-flow-in-img', color: 'purple', class: 'cable-e3' }},
      {{ from: 'port-chatgpt-out-grok', to: 'port-grok-in-img', color: 'purple', class: 'cable-e4' }},
      {{ from: 'port-pflow-out', to: 'port-flow-in-txt', color: 'cyan', class: 'cable-e5' }},
      {{ from: 'port-pgrok-out', to: 'port-grok-in-txt', color: 'cyan', class: 'cable-e6' }}
    ];

    function updateDynamicCables() {{
      const container = document.getElementById('nodeCanvasContainer');
      const svg = document.getElementById('dynamicCanvasSvg');
      ...
      CABLE_EDGES.forEach(edge => {{
        ...
        pathsHtml += `
          <path d="${{d}}" fill="none" stroke="${{grad}}" stroke-width="2.6" opacity="0.5" stroke-linecap="round" />
    ...
    // Listeners for cable recalculation
    window.addEventListener('resize', updateDynamicCables);
    window.addEventListener('load', () => setTimeout(updateDynamicCables, 400));
    setTimeout(updateDynamicCables, 600);
    setTimeout(updateDynamicCables, 1500);

    // 16. Simulated Workflow Node Execution Cycling
    const SIM_NODES = ['node-ref', 'node-p-chatgpt', 'node-chatgpt', 'node-p-flow', 'node-flow', 'node-p-grok', 'node-grok'];
    let simNodeIdx = 0;
    ...
    setInterval(runWorkflowCycle, 1600);
