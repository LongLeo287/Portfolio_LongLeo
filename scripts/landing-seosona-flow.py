...
<head>
  ...
  <style>
    ...
    *, *::before, *::after {{
    ...
    /* ==========================================================================
       INTERACTIVE CHARACTER CONSISTENCY NODE CANVAS
       ========================================================================== */
    .node-canvas-section {{
      padding: 40px 0 90px;
    }}
    ...
    @media (max-width: 1040px) {{
      .node-flow-layout {{ grid-template-columns: 1fr; gap: 24px; }}
    }}
    ...
    .port-right {{ right: -11px; top: 50%; transform: translateY(-50%); }}
    .port-left {{ left: -11px; top: 50%; transform: translateY(-50%); }}
  ...
  <main id="mainContent">
    ...
    <section class="node-canvas-section wrap" id="node-canvas">
      ...
      <div class="dot-grid-canvas">
        <div class="node-flow-layout">
          <!-- Col 1: Reference Node -->
          <div class="v-node-card">
            <div class="v-node-port port-right">🖼️</div>
            <div class="v-node-head">
              <span>🖼️ Reference Image</span>
              <span style="font-family:var(--font-mono);font-size:11px;color:var(--cyan);">SOURCE</span>
            </div>
            <div class="v-node-img-wrap" style="aspect-ratio:3/4;">
              <img src="gallery/g01-480.webp" onerror="this.src='landing/gallery/g01-480.webp'" alt="Character Reference" loading="lazy" />
            </div>
            <div style="margin-top:10px;font-size:12px;color:var(--text-muted);font-family:var(--font-mono);">
              Locked Entity: Character #1003
            </div>
          </div>
          ...
          <div style="display:flex;flex-direction:column;gap:18px;">
            <!-- Prompt Top -->
            <div class="v-node-card">
              <div class="v-node-port port-left">T</div>
              <div class="v-node-port port-right">T</div>
              <div class="v-node-head">
                <span>📝 Prompt (Motion)</span>
                <span style="font-size:11px;color:var(--emerald);">NLP OK</span>
              </div>
              <div class="v-node-prompt-text">
                "Animate reference character into 8s cinematic video. Smooth gimbal dolly in, volumetric lighting, lock outfit across frames."
              </div>
            </div>

            <!-- ChatGPT Center -->
            <div class="v-node-card">
              <div class="v-node-port port-left">🖼️</div>
              <div class="v-node-port port-right">🎬</div>
              <div class="v-node-head">
                <span>🧠 ChatGPT Plus</span>
                <span style="font-size:11px;color:#10a37f;">GPT-4o</span>
              </div>
              <div class="v-node-img-wrap" style="aspect-ratio:16/9;">
                <img src="gallery/g12-480.webp" onerror="this.src='landing/gallery/g12-480.webp'" alt="Scene 2" loading="lazy" />
              </div>
            </div>
            ...
            <div class="v-node-card">
              ...
              <div class="v-node-head">
                ...
                <span style="font-size:11px;color:var(--amber);">POSTER</span>
              </div>
              <div class="v-node-prompt-text">
                "Reimagine reference subject as bold neon billboard poster in rainy Times Square. High-contrast studio rim light."
              </div>
            </div>
          </div>
          ...
          <div style="display:flex;flex-direction:column;gap:18px;">
            <!-- Flow Video -->
            <div class="v-node-card">
              <div class="v-node-port port-left">🎬</div>
              <div class="v-node-head">
                <span>🌊 Google Flow — Video (Veo 3.1)</span>
                <span style="color:var(--cyan);font-family:var(--font-mono);font-size:11px;">1080P · 60FPS</span>
              </div>
              <div class="v-node-img-wrap" style="aspect-ratio:16/9;position:relative;">
                <img src="gallery/g03-480.webp" onerror="this.src='landing/gallery/g03-480.webp'" alt="Veo 3.1 Video" loading="lazy" />
                <div style="position:absolute;inset:0;display:grid;place-items:center;background:rgba(0,0,0,0.3);">
                  <div style="width:44px;height:44px;border-radius:50%;background:rgba(0,242,254,0.85);color:#04060a;display:grid;place-items:center;font-size:16px;box-shadow:0 0 20px var(--cyan);">▶</div>
                </div>
              </div>
            </div>
            ...
            <div class="v-node-card">
              <div class="v-node-port port-left">🖼️</div>
              <div class="v-node-head">
                <span>⚡ Grok 2 — Times Square Poster</span>
                <span style="color:var(--amber);font-family:var(--font-mono);font-size:11px;">FLUX 1.1 PRO</span>
              </div>
              <div class="v-node-img-wrap" style="aspect-ratio:16/9;">
                <img src="gallery/g06-480.webp" onerror="this.src='landing/gallery/g06-480.webp'" alt="Grok Image" loading="lazy" />
              </div>
            </div>
          </div>
        </div>
