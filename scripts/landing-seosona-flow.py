...
<body>
  ...
  <main id="mainContent">
    ...
    <section class="node-canvas-section wrap" id="node-canvas">
      ...
      <div class="dot-grid-canvas">
        <!-- Glowing SVG Bézier Spline Overlay with animated photons -->
        <svg class="canvas-svg-overlay" viewBox="0 0 1140 680" fill="none" preserveAspectRatio="none">
          <defs>
          ...
          <!-- Cable 1: Ref Image (Right Port) -> Prompt Top (Left Port) -->
          <path class="cable-path" d="M 240 180 C 275 180, 270 70, 310 70" />
          <path class="cable-path-pulse" d="M 240 180 C 275 180, 270 70, 310 70" />

          <!-- Cable 2: Ref Image (Right Port) -> ChatGPT Center (Left Port) -->
          <path class="cable-path" d="M 240 180 C 275 180, 270 240, 310 240" />
          <path class="cable-path-pulse" d="M 240 180 C 275 180, 270 240, 310 240" />

          <!-- Cable 3: Ref Image (Right Port) -> Prompt Bottom (Left Port) -->
          <path class="cable-path" d="M 240 180 C 275 180, 270 510, 310 510" />
          <path class="cable-path-pulse" d="M 240 180 C 275 180, 270 510, 310 510" />

          <!-- Cable 4: Prompt Top (Right Port) -> Flow Video (Left Port) -->
          <path class="cable-path" d="M 610 70 C 650 70, 640 100, 680 100" />
          <path class="cable-path-pulse" d="M 610 70 C 650 70, 640 100, 680 100" />

          <!-- Cable 5: ChatGPT (Right Port 1) -> Flow Video (Left Port) -->
          <path class="cable-path" d="M 610 230 C 650 230, 640 150, 680 150" />
          <path class="cable-path-pulse" d="M 610 230 C 650 230, 640 150, 680 150" />

          <!-- Cable 6: ChatGPT (Right Port 2) -> Grok Poster (Left Port) -->
          <path class="cable-path" d="M 610 260 C 650 260, 640 430, 680 430" />
          <path class="cable-path-pulse" d="M 610 260 C 650 260, 640 430, 680 430" />

          <!-- Cable 7: Prompt Bottom (Right Port) -> Grok Poster (Left Port) -->
          <path class="cable-path" d="M 610 510 C 650 510, 640 490, 680 490" />
          <path class="cable-path-pulse" d="M 610 510 C 650 510, 640 490, 680 490" />
        </svg>

        <div class="node-graph-grid">
          <!-- Col 1: Reference Node -->
          <div class="n-node-card">
            <div class="n-node-port n-port-r n-port-purple" title="Output: Identity Embeddings">🖼️</div>
            ...
            <div class="n-node-img-box" style="aspect-ratio: 3/4;">
              <img src="assets/char_ref.webp" onerror="this.src='landing/assets/char_ref.webp'" alt="Character Reference" loading="lazy" width="240" height="320" />
              <div class="n-node-zoom-btn">🔍</div>
            </div>
            <div class="n-node-footer">
              <span style="color:#a3e635;">● Active Lock</span>
          ...
          <div style="display:flex;flex-direction:column;gap:18px;">
            <!-- Prompt Top -->
            <div class="n-node-card">
              <div class="n-node-port n-port-l" style="top:50%;">T</div>
              <div class="n-node-port n-port-r" style="top:50%;">T</div>
              <div class="n-node-head">
                <span>📝 Prompt (Motion)</span>
                <span class="n-node-tag">484/40,000</span>
              </div>
              <div class="n-node-prompt-body">
                Animate the reference character into an 8-second cinematic video. Slow dolly-in toward the subject with smooth gimbal motion. Hair and fabric react gently to a soft breeze. Warm golden-hour lighting with volumetric light rays.
              </div>
              <div class="n-node-footer">
            ...
            <!-- ChatGPT Center -->
            <div class="n-node-card">
              <div class="n-node-port n-port-l n-port-purple" style="top:50%;">🖼️</div>
              <div class="n-node-port n-port-r" style="top:35%;">🎬</div>
              <div class="n-node-port n-port-r n-port-purple" style="top:65%;">🖼️</div>
              <div class="n-node-head">
                <span style="display:flex;align-items:center;gap:6px;">
              ...
              <div class="n-node-img-box" style="aspect-ratio: 16/9;">
                <img src="assets/char_nyc.webp" onerror="this.src='landing/assets/char_nyc.webp'" alt="ChatGPT Scene" loading="lazy" width="300" height="170" />
                <div class="n-node-zoom-btn">🔍</div>
              </div>
              <div class="n-node-footer">
            ...
            <div class="n-node-card">
              ...
              <div class="n-node-prompt-body">
                Reimagine the reference subject as a bold poster shot. High-contrast studio lighting with dramatic shadows. Vibrant accent colors and crisp clean edges. Confident pose with a direct gaze to camera. Sharp focus and fine detail on textures.
              </div>
              <div class="n-node-footer">
          ...
          <div style="display:flex;flex-direction:column;gap:18px;">
            <!-- Flow Video -->
            <div class="n-node-card">
              <div class="n-node-port n-port-l" style="top:30%;">🎬</div>
              <div class="n-node-port n-port-l" style="top:70%;">T</div>
              <div class="n-node-head">
                <span style="display:flex;align-items:center;gap:6px;">
              ...
              <div class="n-node-img-box" style="aspect-ratio: 16/9;position:relative;">
                <img src="assets/char_nyc.webp" onerror="this.src='landing/assets/char_nyc.webp'" alt="Veo 3.1 Video Render" loading="lazy" width="560" height="315" />
                <div style="position:absolute;inset:0;display:grid;place-items:center;background:rgba(0,0,0,0.25);">
                  <div style="width:48px;height:48px;border-radius:50%;background:rgba(0,242,254,0.9);color:#030712;display:grid;place-items:center;font-size:18px;box-shadow:0 0 25px var(--cyan);cursor:pointer;transition:transform 0.2s;" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'">▶</div>
                </div>
              </div>
              <div class="n-node-footer">
                <span style="color:var(--cyan);">● 1080P · 60FPS · 8s</span>
            ...
            <!-- Grok Poster -->
            <div class="n-node-card">
              <div class="n-node-port n-port-l n-port-purple" style="top:35%;">🖼️</div>
              <div class="n-node-port n-port-l" style="top:65%;">T</div>
              <div class="n-node-head">
                <span style="display:flex;align-items:center;gap:6px;">
              ...
              <div class="n-node-img-box" style="aspect-ratio: 16/9;">
                <img src="assets/char_ts.webp" onerror="this.src='landing/assets/char_ts.webp'" alt="Grok Times Square Render" loading="lazy" width="560" height="315" />
                <div class="n-node-zoom-btn">🔍</div>
              </div>
              <div class="n-node-footer">
