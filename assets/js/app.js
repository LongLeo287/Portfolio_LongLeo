...
async function initApp() {
  ...
  try {
    const res = await fetch('assets/data/projects.json?v=1.18');
...
const translations = {
  vi: {
    ...
    labs_eyebrow: 'Mã nguồn mở',
    labs_title: 'Không chỉ dùng công cụ — mình xây luôn công cụ.',
    labs_desc: 'Những hệ thống mình tự phát triển để tự động hoá quy trình sản xuất của chính mình.<br>Toàn bộ mã nguồn công khai.',
    labs_all: 'Xem toàn bộ trên GitHub ↗',
  ...
  en: {
    ...
    labs_eyebrow: 'Open source',
    labs_title: 'Not just using tools — I build them.',
    labs_desc: 'Systems I built to automate my own production workflow.<br>All source code is public.',
    labs_all: 'See everything on GitHub ↗',
    port_eyebrow: 'Portfolio',
