...
const translations = {
  vi: {
    ...
    about_p3_long: '<strong>Mục tiêu dài hạn:</strong> Trở thành Chuyên gia hoạch định Chiến lược nội dung (Content Strategist), dẫn dắt đội ngũ sáng tạo và quản lý các dự án truyền thông đa phương tiện quy mô lớn.',
  ...
  en: {
    ...
    about_p3_long: '<strong>Long-term Goal:</strong> Become a Content Strategist, leading creative teams and managing large-scale multimedia communication projects.',
